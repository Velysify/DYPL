...
class MergingAlgorithm(object):
    pass

class Based_on_common_tastes(MergingAlgorithm):
    def merge(self, *matching_categories):
...
class By_compromising(MergingAlgorithm):
    def merge(self, *matching_categories):
        merged_matching_category = {}
...
class PlaylistMergerAlgorithm(object):
    pass

class Simple_merger(PlaylistMergerAlgorithm):
    def merge(self, new_playlist, *playlists):
